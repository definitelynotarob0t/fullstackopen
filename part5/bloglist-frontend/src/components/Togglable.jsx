...
const Togglable = forwardRef((props, refs) => {
  ...
  useImperativeHandle(refs, () => { // useImperativeHandle is used for defining functions in a component, which can be invoked from outside of the component, i.e. in NewBlogForm
    return {
      toggleVisibility
    }
  })
