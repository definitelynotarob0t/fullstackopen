...
test('by default - renders title and author of blogs, not URL or likes', () => {
  ...
  expect(div).not.toHaveTextContent('https://fullstackopen.com/en/part5/testing_react_apps')
...
test("clicking the view button shows blogs' likes and URL", async () => {
    ...
    expect(div).toHaveTextContent('https://fullstackopen.com/en/part5/testing_react_apps')
